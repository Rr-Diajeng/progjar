...
class HTMLParser:
    ...
    def send_message(self):
        ...
        while True:
            ...
            if not data:
                break
            self.response += data.decode('iso-8859-1')

        self.separate_header()

    def separate_header(self):
        self.header, _, self.content = self.response.partition('\r\n\r\n')

    def get_charset(self):
        # Mencari charset dalam header Content-Type
        match = re.search(r'Content-Type:.*charset=([\w-]+)', self.header, re.IGNORECASE)
