...
class TestHTMLParser(unittest.TestCase):
    ...
    def test_get_menu(self):
        ...
        menu_ok = ['Panduan Dosen', 'Unduh PDF', '[Video] Panduan Membuat Video Asinkronus dengan Power Point', 'Panduan Mahasiswa', 'Unduh PDF']

        menu = self.parser.get_menu()
        for item in menu:
            self.assertIn(item, menu_ok)
